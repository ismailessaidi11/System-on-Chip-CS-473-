...
int main() {
   fixed CX_0_fixed = float_to_q4_28(CX_0);
   fixed CY_0_fixed = float_to_q4_28(CY_0);
   ...
   fixed delta_fixed = float_to_q4_28(delta);
...
#endif
/*
   float test_value = -4;//3.14159;  // Example float value
   fixed fixed_value;
   do {
   fixed_value = float_to_q4_28(test_value);

   printf("fixed value of %f: %d\n", test_value,fixed_value);
   test_value += 0.25;
   } while (test_value < 4);
*/
